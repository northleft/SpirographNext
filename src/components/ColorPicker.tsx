...
const DraggableColorCanvas = ({
  ...
  return (
    <div
      ref={colorAreaRef}
      className="absolute h-48 w-full touch-auto overscroll-none rounded-xl border border-zinc-200 dark:touch-auto dark:border-zinc-700"
      style={{
...
const ColorPicker = ({
  ...
  return (
    <>
      ...
      />
      <div className="fixed h-full w-full top-0 left-0 z-30" onClick={exitHandle}></div>
      <div
        style={
          {
          top: top + 'px',
        ...
        className="absolute z-30 flex w-full max-w-[300px] select-none flex-col items-center gap-3 overscroll-none rounded-2xl border border-zinc-200 bg-white p-4 shadow-md dark:border-zinc-700 dark:bg-zinc-900"
      >
